...
class RampalphaScheduler(Scheduler):
    ...
    @property
    def value(self):
        return self.get_lr(self.epoch, self.begin_epoch, self.max_epoch, self.min_value)

    @staticmethod
    def get_lr(epoch, begin_epoch, max_epoch, min_value):
        if epoch < begin_epoch:
            return 1.0
